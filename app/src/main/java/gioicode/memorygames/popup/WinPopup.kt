...
import gioicode.memorygames.databinding.PopupWinBinding

class WinPopup(var mainActivity: MainActivity, viewBindingParam: ViewBinding) {
    var viewBinding = PopupWinBinding.bind(viewBindingParam.root)
    init {
